...
Goals for V2:
Tie into FCP 
  make it possible to trim files which are used in projects (currently if trimmed, the marked Favorits, etc 
  are lost, and Projects loose their connection to the clip)
